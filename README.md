...
```shell
gem install ./invoicetronic_sdk-1.4.gem
```

(for development, run `gem install --dev ./invoicetronic_sdk-1.4.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'invoicetronic_sdk', '~> 1.4'

  ...
  class UpdateApi
    ...
    def invoice_v1_update_get_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UpdateApi.invoice_v1_update_get ...'
      end
      ...
      # resource path
      local_var_path = '/invoice/v1/update'
      ...
      new_options = opts.merge(
        :operation => :"UpdateApi.invoice_v1_update_get",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UpdateApi#invoice_v1_update_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def invoice_v1_update_id_get(id, opts = {})
      data, _status_code, _headers = invoice_v1_update_id_get_with_http_info(id, opts)
      data
    end
    ...
    def invoice_v1_update_id_get_with_http_info(id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UpdateApi.invoice_v1_update_id_get ...'
      end
      # verify the required parameter 'id' is set
      if @api_client.config.client_side_validation && id.nil?
        fail ArgumentError, "Missing the required parameter 'id' when calling UpdateApi.invoice_v1_update_id_get"
      end
      # resource path
      local_var_path = '/invoice/v1/update/{id}'.sub('{' + 'id' + '}', CGI.escape(id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"UpdateApi.invoice_v1_update_id_get",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UpdateApi#invoice_v1_update_id_get\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end

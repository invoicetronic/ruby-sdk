...
module Invoicetronic_Sdk
  class SendApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def send_validate_files_post(files, opts = {})
      send_validate_files_post_with_http_info(files, opts)
      nil
    end
    ...
    def send_validate_files_post_with_http_info(files, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: SendApi.send_validate_files_post ...'
      end
      # verify the required parameter 'files' is set
      if @api_client.config.client_side_validation && files.nil?
        fail ArgumentError, "Missing the required parameter 'files' when calling SendApi.send_validate_files_post"
      end
      # resource path
      local_var_path = '/send/validate/files'
      ...
      new_options = opts.merge(
        :operation => :"SendApi.send_validate_files_post",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: SendApi#send_validate_files_post\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end

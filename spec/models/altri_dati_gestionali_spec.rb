...
# Unit tests for Invoice_Sdk::AltriDatiGestionali
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Invoice_Sdk::AltriDatiGestionali do
  let(:instance) { Invoice_Sdk::AltriDatiGestionali.new }

  describe 'test an instance of AltriDatiGestionali' do
    it 'should create an instance of AltriDatiGestionali' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Invoice_Sdk::AltriDatiGestionali)
    end
  end

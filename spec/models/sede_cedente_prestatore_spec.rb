...
# Unit tests for Invoice_Sdk::SedeCedentePrestatore
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Invoice_Sdk::SedeCedentePrestatore do
  let(:instance) { Invoice_Sdk::SedeCedentePrestatore.new }

  describe 'test an instance of SedeCedentePrestatore' do
    it 'should create an instance of SedeCedentePrestatore' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Invoice_Sdk::SedeCedentePrestatore)
    end
  end

...
# Unit tests for Invoice_Sdk::FatturaOrdinaria
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Invoice_Sdk::FatturaOrdinaria do
  let(:instance) { Invoice_Sdk::FatturaOrdinaria.new }

  describe 'test an instance of FatturaOrdinaria' do
    it 'should create an instance of FatturaOrdinaria' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Invoice_Sdk::FatturaOrdinaria)
    end
  end

...
# Unit tests for Invoicetronic_Sdk::CedentePrestatore
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Invoicetronic_Sdk::CedentePrestatore do
  let(:instance) { Invoicetronic_Sdk::CedentePrestatore.new }

  describe 'test an instance of CedentePrestatore' do
    it 'should create an instance of CedentePrestatore' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Invoicetronic_Sdk::CedentePrestatore)
    end
  end

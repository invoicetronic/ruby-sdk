...
# Unit tests for Invoice_Sdk::WebHook
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Invoice_Sdk::WebHook do
  let(:instance) { Invoice_Sdk::WebHook.new }

  describe 'test an instance of WebHook' do
    it 'should create an instance of WebHook' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Invoice_Sdk::WebHook)
    end
  end

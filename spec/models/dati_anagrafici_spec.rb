...
# Unit tests for Invoicetronic_Sdk::DatiAnagrafici
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Invoicetronic_Sdk::DatiAnagrafici do
  #let(:instance) { Invoicetronic_Sdk::DatiAnagrafici.new }

  describe 'test an instance of DatiAnagrafici' do
    it 'should create an instance of DatiAnagrafici' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Invoicetronic_Sdk::DatiAnagrafici)
    end
  end

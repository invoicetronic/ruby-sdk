...
# Unit tests for Invoice_Sdk::ScontoMaggiorazione
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Invoice_Sdk::ScontoMaggiorazione do
  let(:instance) { Invoice_Sdk::ScontoMaggiorazione.new }

  describe 'test an instance of ScontoMaggiorazione' do
    it 'should create an instance of ScontoMaggiorazione' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Invoice_Sdk::ScontoMaggiorazione)
    end
  end

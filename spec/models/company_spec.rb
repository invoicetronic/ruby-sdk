...
# Unit tests for Invoice_Sdk::Company
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Invoice_Sdk::Company do
  let(:instance) { Invoice_Sdk::Company.new }

  describe 'test an instance of Company' do
    it 'should create an instance of Company' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Invoice_Sdk::Company)
    end
  end

...
# Unit tests for Invoicetronic_Sdk::DatiDDT
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Invoicetronic_Sdk::DatiDDT do
  let(:instance) { Invoicetronic_Sdk::DatiDDT.new }

  describe 'test an instance of DatiDDT' do
    it 'should create an instance of DatiDDT' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Invoicetronic_Sdk::DatiDDT)
    end
  end
